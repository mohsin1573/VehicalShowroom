...
$select->sql_select("SELECT * FROM catagories");
	...
	<div class="main">
		...
		<div class="content">
			<div class="dash-title">
				<h1><i class="fa-solid fa-layer-group"></i> Catagories</h1>
			</div>
			...
			<div class="row">
				<div class="col-11">
					<form id="form1" action="delete_multiple.php" method="post">
						<a href="add_catagory.php" class="add"><i class="fa-solid fa-plus"></i> Add</a>
						<p>Catagories</p>
						<table id="table1">
							<thead>
								<tr>
